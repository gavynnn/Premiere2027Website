...
(() => {
  ...
  "en": {
    ...
    "document.loading": "Preparing PDF preview…",
    "document.previewFailed": "Use Open PDF or Download PDF below if the preview cannot load.",
  ...
  "id": {
    ...
    "document.loading": "Menyiapkan pratinjau PDF…",
    "document.previewFailed": "Gunakan Buka PDF atau Unduh PDF di bawah jika pratinjau tidak dapat dimuat.",
